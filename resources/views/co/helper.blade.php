...
<div id="helper-message" class="helper-box">
    ...
    <div class="helper-box-item helper-shipping">
        Вы выбираете удобный способ доставки и метод оплаты. Уточняете адрес для курьера или пункта самовывоза.
    </div>
    <div class="helper-box-item helper-passport">
        Для товаров из-за рубежа необходимо оформлять документы на растаможку.
    </div>
