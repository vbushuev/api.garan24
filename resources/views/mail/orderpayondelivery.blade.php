...
@section('content')
    ...
    <div style="text-indent: 2em;">
        <i style="font-weight: 700;font-style: normal;font-size: inherit;">В ближайшее</i> время с Вами свяжется наш менеджер для подтверждения заказа. Отследить статус доставки Вашего заказа вы можете через <a href="http://gauzymall.com/my-account/">Личный кабинет <span style="color: #557da1;font-weight: 700;">GauzyMALL</span></a>
    </div>
    <div style="text-indent: 2em;">
