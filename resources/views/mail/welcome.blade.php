...
@section('content')
    <h1 style="font-size: 20pt;text-align: center;line-height: 2em;border-bottom: dotted 1px #557da1;font-weight: 500;margin-bottom: 1em;"><i style="font-weight: 700;font-style: normal;font-size: inherit;">Уважаемый</i> покупатель!</h1>
    ...
    <div style="text-indent: 2em;">
        <i style="font-weight: 700;font-style: normal;font-size: inherit;">Используя</i> <a href="https://www.gauzymall.com/my-account/">Личный кабинет <span style="color: #557da1;font-weight: 700;">GauzyMALL</span></a>, Вы можете отслеживать статус доставки заказа. При покупках у наших партнеров Вам не придется повторно вводить данные для доставки и оплаты заказа.
    </div>
    <div style="text-indent: 2em;">
    ...
    <h2 style="font-size: 18pt;font-weight: 500;margin-bottom: 1em;background-color: #557da1;color: #fff;text-align: center;height: 3em;line-height: 3em;"><i style="font-weight: 700;font-style: normal;font-size: inherit;">Вход</i> в личный кабинет</h2>
    <div style="padding: 1em;line-height: 2em;font-size: 110%;">
        Страница: <a href="https://www.gauzymall.com/my-account">https://www.gauzymall.com/my-account</a><br />
