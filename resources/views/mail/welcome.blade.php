...
@section('content')
    ...
    <div style="text-indent: 2em;">
        <i style="font-weight: 700;font-style: normal;font-size: inherit;">Вы</i> сделали заказ в магазине нашего партнера <a href="{{$deal->getShopUrl()}}">{{$deal->getShopUrl()}}</a>, и стали участником сервиса комфортных покупок <span style="color: #557da1;font-weight: 700;text-transform: uppercase;">Гаран24</span>.
    </div>
    <div style="text-indent: 2em;">
        <i style="font-weight: 700;font-style: normal;font-size: inherit;">Используя</i> <a href="https://garan24.ru/myaccount/">Личный кабинет <span style="color: #557da1;font-weight: 700;text-transform: uppercase;">Гаран24</span></a>, Вы можете отслеживать статус доставки заказа. При покупках у наших партнеров Вам не придется повторно вводить данные для доставки и оплаты заказа.
    </div>
    <div style="text-indent: 2em;">
        <i style="font-weight: 700;font-style: normal;font-size: inherit;">Уже</i> сейчас, как участник сервиса <span style="color: #557da1;font-weight: 700;text-transform: uppercase;">Гаран24</span>, Вы можете оплачивать заказ банковской картой при его получении. В дальнейшем мы предложим Вам другие способы оплаты, в том числе, с отсрочкой или рассрочкой платежа.
    </div>
