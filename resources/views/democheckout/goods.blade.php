...
<tr class="cart-item" id="cartItem-{{$good["product_id"]}}">
    <td class="image">
        <img width="70" src="{{$good["product_img"]}}" alt="{{$good["title"]}}">
    </td>
    <td>
        <a class="name" href="{{$good["product_url"]}}" target="_blank">{{$good["title"]}}</a>
    </td>
    <td>
    ...
    <td><div class="cost"><span class="productPrice">{{$good["regular_price"]}}</span> руб.</div></td>
</tr>
@endforeach
@else
