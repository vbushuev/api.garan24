...
var boxberry = {
	...
	init: function(){
		...
		var el = document.createElement('LINK');
			el.rel = 'stylesheet';
			el.type = 'text/css';
			el.href = '//points.boxberry.de/css/boxberry.css';
			h.appendChild(el);
		var el = document.createElement('SCRIPT');
			el.src = '//points.boxberry.de/js/postmessage.js';
			el.onload = function(){
			pm.bind('boxberry-map-point-select', function(data){

					this.callCallbackFunction(data);
					this.hideOverlay();
					this.hideContainer();
				}.bind(this));
			}.bind(this);
	...
	showContainer: function(){
		...
		this._container.style.top = (s.top + Math.max(0, (document.documentElement.clientHeight - this._container.offsetHeight) / 2)) + 'px';
