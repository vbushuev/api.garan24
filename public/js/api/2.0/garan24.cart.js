        ...
        cart:{
            ...
            alreadyitem:function(good){
                for(var i in this.order.items){
                    ...
                    if(it.sku==good.sku
                        &&it.title==good.title
                        &&it.original_price==good.original_price
                        &&it.product_url==good.product_url) {
            ...
            checkout:function(){
                ...
                $.ajax({
                    ...
                    url:(document.location.hostname.match(/\.bs2/i))?"//service.garan24.bs2/checkout":"http://checkout.gauzymall.com",
                    dataType: "json",
